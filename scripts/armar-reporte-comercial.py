...
@media (max-width: 980px) {
  ...
  /* El brief y la conclusion no son destinos de la barra: son la
     apertura y el cierre del documento. Si entran en la regla de
     ocultar, abajo de 980px desaparecen y no hay boton que los
     traiga de vuelta. Quedan fijos, y lo que conmuta es el medio. */
  .app-shell[data-grupo] .content > section:not(#brief):not(#conclusion) { display: none; }
...
(function () {
  var SECCION = { crm: 'crm', meta: 'meta', retargeting: 'retargeting', sitio: 'sitio' };
